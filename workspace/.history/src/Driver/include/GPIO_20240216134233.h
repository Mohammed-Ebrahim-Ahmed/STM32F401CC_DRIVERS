 ...
 * 
 */
#define GPIO_PORTA_SEL ((volatile GPIO_Peri_t* const) 0x40020000)
#define GPIO_PORTB_SEL ((volatile GPIO_Peri_t* const) 0x40020400)
#define GPIO_PORTC_SEL ((volatile GPIO_Peri_t* const) 0x40020800)
 ...
 */
#define GPIO_PP             0x0
#define GPIO_PP_PU          0x1
#define GPIO_PP_PD          0x2
#define GPIO_OD             0x4
#define GPIO_OD_PU          0x5
#define GPIO_OD_PD          0x6
/**
 * @brief this for the input
 * 
 */
#define GPIO_FLOATING       0x0
#define GPIO_PU             0x1
#define GPIO_PD             0x2
/**
 * @brief This is for the analog 
 * 
 */
#define GPIO_ANALOG_DUMMY   0x0
/********************************************************************************************************************/
