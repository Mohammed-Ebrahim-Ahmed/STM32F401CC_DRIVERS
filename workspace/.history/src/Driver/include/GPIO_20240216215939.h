 ...
 * 
 */
#define GPIO_PORTA ((volatile uint32_t* const) 0x40020000)
#define GPIO_PORTB ((vjolatile uint32_t* const) 0x40020400)
#define GPIO_PORTC (volatile uint32_t* const) 0x40020800)
