...
GPIO_ErrorStatus_t GPIO_init(GPIO_Pin_t* GPIO_Pin)
{
    ...
    else if(((volatile void* const)GPIO_Pin->Port != GPIO_PORTA) &&
            ((volatile void* const)GPIO_Pin->Port != GPIO_PORTB) &&
            ((volatile void* const)GPIO_Pin->Port != GPIO_PORTC)  )
    {
...
GPIO_ErrorStatus_t GPIO_SetPinValue(volatile void* GPIO_Port, uint32_t GPIO_Pin, uint32_t GPIO_Val_Set)
{
    ...
    else if(((volatile void* const)GPIO_Port != GPIO_PORTA) &&
            ((volatile void* const)GPIO_Port != GPIO_PORTB) &&
            ((volatile void* const)GPIO_Port != GPIO_PORTC))
    {
        LOC_ErrorStatus = GPIO_WrongPort;
    }
