...
GPIO_ErrorStatus_t GPIO_init(GPIO_Pin_t* GPIO_Pin)
{
    ...
    else if((((volatile GPIO_Peri_t* const)GPIO_Pin->Port) != GPIO_PORTA) &&
            (((volatile GPIO_Peri_t* const)GPIO_Pin->Port) != GPIO_PORTB) &&
            (((volatile GPIO_Peri_t* const)GPIO_Pin->Port) != GPIO_PORTC) )
    {
